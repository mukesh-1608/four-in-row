...
func GetBestMove(g *game.Game, botColor int) (int, error) {
        ...
        // Priority order: 3 (Center), 2/4 (Near Center), 1/5 (Outer), 0/6 (Edge)
        // This heuristic maximizes potential connection opportunities as center control is critical in Connect 4.
